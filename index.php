...
<main role="main">
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <h2>Nombres</h2>
        <p>Encontraras los nombres de los jugadores del campeonato. </p>
      </div>
      <div class="col-md-4">
        <h2>Semanas</h2>
        <p>Podras ver todas las semanas de los jugadores y sus campeonatos. </p>
      </div>
    </div>
    <div class="col-md-4">
        <h2>Campeonatos</h2>
        <p>Podras ver todas lss campeonatos y las semanas de los jugadores. </p>
      </div>
<img src="fifa.jpg" width="400" height="453"/>
    <hr>
